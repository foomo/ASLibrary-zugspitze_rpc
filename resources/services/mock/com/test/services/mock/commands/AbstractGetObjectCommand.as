package com.test.services.mock.commands
{
	...
	public class AbstractGetObjectCommand extends Command implements ICommand, IUnload
	{
		...
		public function execute():void
		{
			...
			this._methodCall.addEventListener(GetObjectCallEvent.GET_OBJECT_CALL_ERROR, this.abstractErrorHandler);
			this._methodCall.addEventListener(GetObjectCallEvent.GET_OBJECT_CALL_PROGRESS, this.abstractProgressHandler);
			this._methodCall.addEventListener(GetObjectCallEvent.GET_OBJECT_CALL_COMPLETE, this.abstractCompleteHandler);
		}
		...
		public function unload():void
		{
			...
			this.value = null;
			if (this._methodCall) {
				this._methodCall.removeEventListener(GetObjectCallEvent.GET_OBJECT_CALL_ERROR, this.abstractErrorHandler);
				this._methodCall.removeEventListener(GetObjectCallEvent.GET_OBJECT_CALL_PROGRESS, this.abstractProgressHandler);
				this._methodCall.removeEventListener(GetObjectCallEvent.GET_OBJECT_CALL_COMPLETE, this.abstractCompleteHandler);
		 ...
		 */
		protected function abstractProgressHandler(event:GetObjectCallEvent):void
		{
		 ...
		 * @param event Method call event
		 */
		protected function abstractCompleteHandler(event:GetObjectCallEvent):void
		{
			// Overwrite this method in your implementation class
		 ...
		 * @param event Method call event
		 */
		protected function abstractErrorHandler(event:GetObjectCallEvent):void
		{
			// Overwrite this method in your implementation class
